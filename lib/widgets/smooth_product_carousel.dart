...
import 'package:foodie_pedia/cards/product_cards/smooth_product_card_error.dart';
import 'package:foodie_pedia/cards/product_cards/smooth_product_card_loading.dart';
import 'package:foodie_pedia/cards/product_cards/smooth_product_card_not_found.dart';
import 'package:foodie_pedia/cards/product_cards/smooth_product_card_thanks.dart';
import 'package:foodie_pedia/data_models/continuous_scan_model.dart';
import 'package:foodie_pedia/data_models/tagline.dart';
...
import 'package:foodie_pedia/pages/scan/inherited_data_manager.dart';
import 'package:foodie_pedia/pages/scan/scan_product_card.dart';
import 'package:foodie_pedia/pages/scan/search_page.dart';
                    ...
                    onTap: data.data!.hasLink
                        ? () async {
                            if (await canLaunchUrlString(data.data!.url)) {
                              await launchUrl(
                                Uri.parse(
                                    "https://forms.gle/q9B3eU8viChFwmGv8"),
                        ...
                        : null,
                    child: AutoSizeText(
                      '😊 We\'d like your feedback about our app',
                      style: TextStyle(
