...
import 'package:foodie_pedia/pages/preferences/user_preferences_account.dart';
import 'package:foodie_pedia/pages/preferences/user_preferences_connect.dart';
import 'package:foodie_pedia/pages/preferences/user_preferences_contribute.dart';
import 'package:foodie_pedia/pages/preferences/user_preferences_dev_mode.dart';
import 'package:foodie_pedia/pages/preferences/user_preferences_faq.dart';
import 'package:foodie_pedia/pages/preferences/user_preferences_food.dart';
import 'package:foodie_pedia/pages/preferences/user_preferences_settings.dart';
import 'package:foodie_pedia/pages/preferences/user_preferences_user_lists.dart';
...
class _UserPreferencesPageState extends State<UserPreferencesPage>
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.type == null) {
      ...
      headerAsset = 'assets/preferences/preference.png';
